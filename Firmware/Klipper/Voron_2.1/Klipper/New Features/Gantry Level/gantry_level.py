...
class GantryLevel:
    ...
    def finalize(self, z_offset, positions):
        ...
        a1 = [positions[0][1] + self.probe_location[1], self.plot(f1,self.gantry_corners[0][0])]
        a2 = [positions[1][1] + self.probe_location[1], self.plot(f2,self.gantry_corners[0][0])]
        b1 = [positions[0][1] + self.probe_location[1], self.plot(f1,self.gantry_corners[1][0])]
        b2 = [positions[1][1] + self.probe_location[1], self.plot(f2,self.gantry_corners[1][0])]
